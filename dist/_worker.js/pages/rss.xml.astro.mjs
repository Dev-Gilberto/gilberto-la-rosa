...
class ZodNativeEnum extends ZodType {
    ...
    _parse(input) {
        ...
        if (!__classPrivateFieldGet(this, _ZodNativeEnum_cache)) {
            __classPrivateFieldSet(this, _ZodNativeEnum_cache, new Set(util$4.getValidEnumValues(this._def.values)));
        }
...
const rssSchema = objectType({
  ...
  pubDate: unionType([stringType(), numberType(), dateType()]).optional().transform((value) => value === void 0 ? value : new Date(value)).refine((value) => value === void 0 ? value : !isNaN(value.getTime())),
