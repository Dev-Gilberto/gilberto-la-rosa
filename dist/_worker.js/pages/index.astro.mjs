...
import { $ as $$SocialNetwork, a as $$Icon } from '../chunks/SocialNetwork_PEbGz6Tm.mjs';
...
const $$AllTags = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$AllTags;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/post/comandos-mas-usados-en-git.mdx": () => import('../chunks/comandos-mas-usados-en-git_CssKFhqp.mjs').then(n => n._),"../pages/post/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('../chunks/como-obtener-tu-primer-empleo-como-web-developer__hVWqVoH.mjs').then(n => n._),"../pages/post/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('../chunks/como-utilizar-git-y-github-en-un-ambiente-profesional_DrJXXYiN.mjs').then(n => n._),"../pages/post/el-origen-de-javascript.mdx": () => import('../chunks/el-origen-de-javascript_CjOGvKtu.mjs').then(n => n._),"../pages/post/guia-para-ser-un-desarrollador-web.mdx": () => import('../chunks/guia-para-ser-un-desarrollador-web_BAjTKIH3.mjs').then(n => n._),"../pages/post/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('../chunks/que-es-devin-el-primer-ingeniero-de-software-de-ia_3_hQ7f8y.mjs').then(n => n._),"../pages/post/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('../chunks/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_UnLE3kE2.mjs').then(n => n._)}), () => "../pages/post/*.mdx");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./post/comandos-mas-usados-en-git.mdx": () => import('../chunks/comandos-mas-usados-en-git_CssKFhqp.mjs').then(n => n._),"./post/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('../chunks/como-obtener-tu-primer-empleo-como-web-developer__hVWqVoH.mjs').then(n => n._),"./post/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('../chunks/como-utilizar-git-y-github-en-un-ambiente-profesional_DrJXXYiN.mjs').then(n => n._),"./post/el-origen-de-javascript.mdx": () => import('../chunks/el-origen-de-javascript_CjOGvKtu.mjs').then(n => n._),"./post/guia-para-ser-un-desarrollador-web.mdx": () => import('../chunks/guia-para-ser-un-desarrollador-web_BAjTKIH3.mjs').then(n => n._),"./post/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('../chunks/que-es-devin-el-primer-ingeniero-de-software-de-ia_3_hQ7f8y.mjs').then(n => n._),"./post/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('../chunks/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_UnLE3kE2.mjs').then(n => n._)}), () => "./post/*.mdx");
  const formattedPosts = formatBlogPosts(allPosts);
