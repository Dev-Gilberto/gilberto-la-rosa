...
import { $ as $$SocialNetwork, a as $$Icon } from '../chunks/SocialNetwork_Gqnfit1c.mjs';
...
const $$AllTags = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$AllTags;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/post/comandos-mas-usados-en-git.mdx": () => import('../chunks/comandos-mas-usados-en-git_CBZtWmQJ.mjs').then(n => n._),"../pages/post/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('../chunks/como-obtener-tu-primer-empleo-como-web-developer_DIHbkjoW.mjs').then(n => n._),"../pages/post/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('../chunks/como-utilizar-git-y-github-en-un-ambiente-profesional_C6eJtS43.mjs').then(n => n._),"../pages/post/el-origen-de-javascript.mdx": () => import('../chunks/el-origen-de-javascript_4-xO2Lx-.mjs').then(n => n._),"../pages/post/guia-para-ser-un-desarrollador-web.mdx": () => import('../chunks/guia-para-ser-un-desarrollador-web_BYDXBX-Y.mjs').then(n => n._),"../pages/post/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('../chunks/que-es-devin-el-primer-ingeniero-de-software-de-ia_Dvj9slGD.mjs').then(n => n._),"../pages/post/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('../chunks/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CnXzICxi.mjs').then(n => n._)}), () => "../pages/post/*.mdx");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./post/comandos-mas-usados-en-git.mdx": () => import('../chunks/comandos-mas-usados-en-git_CBZtWmQJ.mjs').then(n => n._),"./post/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('../chunks/como-obtener-tu-primer-empleo-como-web-developer_DIHbkjoW.mjs').then(n => n._),"./post/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('../chunks/como-utilizar-git-y-github-en-un-ambiente-profesional_C6eJtS43.mjs').then(n => n._),"./post/el-origen-de-javascript.mdx": () => import('../chunks/el-origen-de-javascript_4-xO2Lx-.mjs').then(n => n._),"./post/guia-para-ser-un-desarrollador-web.mdx": () => import('../chunks/guia-para-ser-un-desarrollador-web_BYDXBX-Y.mjs').then(n => n._),"./post/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('../chunks/que-es-devin-el-primer-ingeniero-de-software-de-ia_Dvj9slGD.mjs').then(n => n._),"./post/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('../chunks/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CnXzICxi.mjs').then(n => n._)}), () => "./post/*.mdx");
  const formattedPosts = formatBlogPosts(allPosts);
