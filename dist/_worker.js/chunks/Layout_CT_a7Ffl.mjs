...
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, e as addAttribute, a as renderComponent, i as renderHead, j as renderTransition, d as renderSlot, k as slide } from './astro/server_zRN-DKkT.mjs';
/* empty css                          */
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head>${renderComponent($$result, "Seo", $$Seo, {})}<title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="relative"> <main${addAttribute(renderTransition($$result, "n3y5j5qa", slide({ duration: "0.6s" })), "data-astro-transition-scope")}> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "FooterLayout", $$FooterLayout, {})} ${renderComponent($$result, "BtnTop", $$BtnTop, {})} </body></html>`;
