...
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, F as spreadAttributes, d as addAttribute, a as renderComponent, G as unescapeHTML, H as Fragment, I as renderHead, J as renderTransition, E as renderSlot, K as slide } from './astro/server_DF50JbGT.mjs';
/* empty css                                              */
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head>${renderComponent($$result, "Seo", $$Seo, {})}<title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body> <section class="relative overflow-hidden"> ${renderComponent($$result, "Icon", $$Icon, { "name": "cpu", "class": "absolute -top-40 -right-40 text-[#212121] opacity-5", "size": 600 })} <main${addAttribute(renderTransition($$result, "vjivwn24", slide({ duration: "0.6s" })), "data-astro-transition-scope")}> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "FooterLayout", $$FooterLayout, {})} ${renderComponent($$result, "BtnTop", $$BtnTop, {})} </section> </body></html>`;
