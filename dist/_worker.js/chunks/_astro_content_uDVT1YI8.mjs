...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://gilberto-la-rosa.xyz/", "ASSETS_PREFIX": undefined}, { Path: process.env.Path })?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_DAzxhgui.mjs'),"/src/content/blog/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_DoLOjAm6.mjs'),"/src/content/blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_oXPWXVRw.mjs'),"/src/content/blog/el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_C_fs4uMP.mjs'),"/src/content/blog/guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_CWvZpkqh.mjs'),"/src/content/blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_BuxpveNJ.mjs'),"/src/content/blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_zbAnQzUk.mjs')});
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"comandos-mas-usados-en-git":"/src/content/blog/comandos-mas-usados-en-git.mdx","como-obtener-tu-primer-empleo-como-web-developer":"/src/content/blog/como-obtener-tu-primer-empleo-como-web-developer.mdx","como-utilizar-git-y-github-en-un-ambiente-profesional":"/src/content/blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx","el-origen-de-javascript":"/src/content/blog/el-origen-de-javascript.mdx","guia-para-ser-un-desarrollador-web":"/src/content/blog/guia-para-ser-un-desarrollador-web.mdx","que-es-devin-el-primer-ingeniero-de-software-de-ia":"/src/content/blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx","que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo":"/src/content/blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_s5OobAfH.mjs'),"/src/content/blog/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_C9PKYwRW.mjs'),"/src/content/blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_vqnfWrrb.mjs'),"/src/content/blog/el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_B1lfst3r.mjs'),"/src/content/blog/guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_DrYKE3SG.mjs'),"/src/content/blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_C3w5kyvx.mjs'),"/src/content/blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_DVY-w0RQ.mjs')});
...
export { $$Icon as $, $$SocialNetwork as a, getCollection as g };
