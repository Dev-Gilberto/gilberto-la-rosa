...
/* empty css                                               */
import { c as createAstro, b as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, e as renderComponent, l as spreadAttributes, u as unescapeHTML, n as Fragment } from '../astro_utylptCb.mjs';
...
const $$AllTags = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$AllTags;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/blog/comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_2VnHzTmU.mjs').then(n => n.c),"../pages/blog/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_Dz11Zy75.mjs'),"../pages/blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_msMCA1w1.mjs'),"../pages/blog/el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_CxE4x0SE.mjs'),"../pages/blog/guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web__WKWu5ca.mjs'),"../pages/blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_DFCnf1np.mjs'),"../pages/blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_DP2st2Fs.mjs')}), () => "../pages/blog/*.mdx");
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_2VnHzTmU.mjs').then(n => n.c),"./como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_Dz11Zy75.mjs'),"./como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_msMCA1w1.mjs'),"./el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_CxE4x0SE.mjs'),"./guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web__WKWu5ca.mjs'),"./que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_DFCnf1np.mjs'),"./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_DP2st2Fs.mjs')}), () => "./*.mdx");
  const formattedPosts = formatBlogPosts(allPosts);
