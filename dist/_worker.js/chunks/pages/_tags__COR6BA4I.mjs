...
const $$tags = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../blog/comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_DQWvWFTc.mjs').then(n => n.c),"../blog/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_0bl0gJvG.mjs'),"../blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_x1hv7qO7.mjs'),"../blog/el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_NLFZvj76.mjs'),"../blog/guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_8kbNqSbb.mjs'),"../blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_BMV13DB_.mjs'),"../blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CBhldw5o.mjs')}), () => "../blog/*.mdx");
