...
import { f as formatBlogPosts, s as slugify, $ as $$Posts } from './_tags__g17xkJvR.mjs';
...
const $$AllTags = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$AllTags;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/blog/comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_B7Ef0v1u.mjs').then(n => n.c),"../pages/blog/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_Dm5eAeQA.mjs'),"../pages/blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_ttZVWQBA.mjs'),"../pages/blog/el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_DVouUNcW.mjs'),"../pages/blog/guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_DJe7UYzC.mjs'),"../pages/blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_D7Co5hvp.mjs'),"../pages/blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CMSGUWe2.mjs')}), () => "../pages/blog/*.mdx");
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_B7Ef0v1u.mjs').then(n => n.c),"./como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_Dm5eAeQA.mjs'),"./como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_ttZVWQBA.mjs'),"./el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_DVouUNcW.mjs'),"./guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_DJe7UYzC.mjs'),"./que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_D7Co5hvp.mjs'),"./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CMSGUWe2.mjs')}), () => "./*.mdx");
  const formattedPosts = formatBlogPosts(allPosts);
...
export { $$Icon as $, $$SocialNetwork as a, index as b, index$1 as i };
