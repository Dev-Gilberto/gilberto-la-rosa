...
const $$AllTags = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$AllTags;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/blog/comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_DDnGhxRR.mjs').then(n => n.c),"../pages/blog/como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_T5bcPNYa.mjs'),"../pages/blog/como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_ecA2-M7i.mjs'),"../pages/blog/el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_DvQ4zRih.mjs'),"../pages/blog/guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_D63Jjl0n.mjs'),"../pages/blog/que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_DFKKezM7.mjs'),"../pages/blog/que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CctR5EfA.mjs')}), () => "../pages/blog/*.mdx");
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./comandos-mas-usados-en-git.mdx": () => import('./comandos-mas-usados-en-git_DDnGhxRR.mjs').then(n => n.c),"./como-obtener-tu-primer-empleo-como-web-developer.mdx": () => import('./como-obtener-tu-primer-empleo-como-web-developer_T5bcPNYa.mjs'),"./como-utilizar-git-y-github-en-un-ambiente-profesional.mdx": () => import('./como-utilizar-git-y-github-en-un-ambiente-profesional_ecA2-M7i.mjs'),"./el-origen-de-javascript.mdx": () => import('./el-origen-de-javascript_DvQ4zRih.mjs'),"./guia-para-ser-un-desarrollador-web.mdx": () => import('./guia-para-ser-un-desarrollador-web_D63Jjl0n.mjs'),"./que-es-devin-el-primer-ingeniero-de-software-de-ia.mdx": () => import('./que-es-devin-el-primer-ingeniero-de-software-de-ia_DFKKezM7.mjs'),"./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo.mdx": () => import('./que-es-la-inteligencia-artificial-y-cual-es-su-impacto-en-el-mundo_CctR5EfA.mjs')}), () => "./*.mdx");
  const formattedPosts = formatBlogPosts(allPosts);
