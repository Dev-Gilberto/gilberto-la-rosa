...
const $$Empleos = createComponent(async ($$result, $$props, $$slots) => {
...
const $$ContadorExperiencia = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$ContadorExperiencia;
  var codafter = 4;
  var hbt = 11;
  var free = 50;
  var ucab = 11;
...
const $$TrabajosDependientes = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$TrabajosDependientes;
...
export { $$TrabajosDependientes as default, $$file as file, $$url as url };
